...
func (m *statefulSetToEtcdMapper) Map(ctx context.Context, _ logr.Logger, reader client.Reader, obj client.Object) []reconcile.Request {
	...
	if err := m.cl.Get(m.ctx, kutil.Key(name, namespace), etcd, nil); err != nil {
		return nil
	}
