...
func (r *EtcdMemberReconciler) reconcile(ctx context.Context, etcdMember *druidv1alpha1.EtcdMember) (result ctrl.Result, err error) {
	...
	// TODO: etcd controller should not update spec if status.lastOperation is not Succeeded|Failed|Aborted
	// TODO: custodian controller to constantly check status.health and update status.status
	...
	// TODO: etcd controller: check storage-related changes and confirmation annotation to update etcdMember.spec.operation
...
func (r *EtcdMemberReconciler) SetupWithManager(mgr ctrl.Manager, workers int) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&druidv1alpha1.EtcdMember{}, builder.WithPredicates(predicate.GenerationChangedPredicate{})).
		Owns(&batchv1.Job{}).
